...
def prepar_model():
    ...
    model.save_model("./classify/models/classify_by_word_100_20_2.model")  #0.9952888912772837
    # model.save_model("./classify/models/classify_100_20_2.model")  #0.9942397448645937
