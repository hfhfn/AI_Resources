...
隐马尔可夫模型中，除了马尔可夫假设之外，还有另外一个假设，即**输出独立性假设**，即:
...
传说海藻的能够预测天气，假如海藻有下面四种状态，天气有三种状态，那么现在我们知道一列海藻的状态`[Damp,Dryish,Dry,Soggy]`,那么我们想知道对应这四种状态的概率，需要如何计算？
...
class ProbilityMartix:
    def __init__(self):
        ...
        #每个状态的总数，上面的/下面的 = 从一个状态到另一个状态的概率 {B:200,E:300}
