...
class ChatDataset(Dataset):
    def __init__(self,train=True):
        input_path = "./corpus/dnnsort/q_train.txt" if train else "./corpus/dnnsort/q_test.txt"
        target_path = "./corpus/dnnsort/sim_q_train.txt" if train else  "./corpus/dnnsort/sim_q_test.txt"
        v_path = "./corpus/dnnsort/v_train.txt" if train else  "./corpus/dnnsort/v_test.txt"
        self.input_data = open(input_path).readlines()
        self.target_data = open(target_path).readlines()
        self.v_data = open(v_path).readlines()
